...
- `pytest` suite (inverter summary sensors) - `2025-11-18 @ 17:50 SAST`, PASS (extends `tests/test_sensor.py` for inverter summary + status sensor).
...
- Targeted inverter summary routes (`python test_routes.py --only inverter_summary inverter_detail_localized --delay 0.3`) - `2025-11-18 @ 17:32 SAST`, PASS (provides latest payload in `.cache/`).
