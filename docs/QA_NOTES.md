...
## Completed
- `pytest` suite (`tests/test_api_client.py`, `tests/test_coordinator.py`) — `2025-11-18 @ 13:45 SAST`, PASS (uses sanitized fixtures in `tests/fixtures` to avoid `.cache` secrets).
